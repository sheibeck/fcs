  ...
  data () {
    return {
      ...
      },
      {
        ...
        "object_type": "CHARACTERSHEET",
        "slug": "fate-core",
        "description": "Fate Core with default skills, stress and consequences or <em>Create Customized</em> to enter your own skills.",
        ...
        "object_type": "CHARACTERSHEET",
        "slug": "star-trek",
        "description": "Fate Accelerated with custom approaches for Star Trek. Includes character and ship sheet.",
